<%-- 
    Document   : service
    Created on : Apr 21, 2024, 3:59:30 PM
    Author     : HP
--%>
...
<body>
    ...
    <div class="topic-container">
        <img src="images\warranty.png" alt="warranty" width="35" height="37"> <span>Warranty</span>
    </div>
    ...
    <div class="topic-container">
        <img src="images\customorder.png" alt="customorder" width="35" height="37"> <span>Custom Orders</span>
    </div>
    ...
    <div class="topic-container">
        <img src="images\homedeliver.png" width="35" height="37" alt="homedeliver"> <span>Home Delivery</span>
    </div>
